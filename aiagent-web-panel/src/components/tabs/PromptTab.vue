<template>
    <Card>
        ...
        <div class="prompt-editor">
            <div class="editor-toolbar">
                ...
                <div class="editor-actions">
                    ...
                    <Button @click="handleFormat" :disabled="loadingStates.format">
                        <span v-if="loadingStates.format" class="btn-loading"></span>
                        <span v-else>✨ Формат</span>
                    </Button>
                    <Button @click="handleCopy" :disabled="loadingStates.copy">
                        <span v-if="loadingStates.copy" class="btn-loading"></span>
            ...
            <div class="editor-container">
                ...
                <div class="preview-container">
                    <div class="preview-header">
                        <span>Preview</span>
                        <Button @click="togglePreview" style="font-size: 10px; padding: 4px 8px">
                            {{ previewVisible ? 'Hide' : 'Show' }}
                        </Button>
                    </div>
                    <div v-if="previewVisible" class="preview-content" v-html="compiledMarkdown"></div>
                </div>
            </div>
        </div>
        <div style="margin-top: 12px; display: flex; gap: 8px">
            ...
            <Button @click="handleExport" :disabled="loadingStates.export">
                <span v-if="loadingStates.export" class="btn-loading"></span>
                <span v-else>📤 Экспорт</span>
            </Button>
            <Button @click="handleImport" :disabled="loadingStates.import">
                <span v-if="loadingStates.import" class="btn-loading"></span>
