  ...
  <div class="console-container">
    <div class="console-header">
      ...
      <div class="header-actions">
        ...
        <Button style="padding: 5px 10px; font-size: 10px" @click="clearLogs"> 🗑️ </Button>
      </div>
    </div>
...
const filteredLogs = computed(() => {
  ...
  return logHistory.value.filter(
    (log) => log.message.toLowerCase().includes(query) || log.time.toLowerCase().includes(query)
  );
});
